...
import { ArrowRight, Cog, Factory, TrendingUp, Shield } from "lucide-react"
...
export default function Cta() {
  const stats = [
    ...
    { value: "24/7", label: "Expert Support", icon: Cog }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Enterprise SAP Integration Specialists
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry-leading manufacturers who have transformed their operations with our SAP integration solutions. 
                Discover how we can optimize your manufacturing processes and drive measurable ROI.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by Fortune 500 manufacturers and mid-market leaders
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Free manufacturing systems analysis and roadmap
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SAP-certified solutions with enterprise-grade security
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Proven Implementation</h3>
              <p className="text-sm text-muted-foreground">
                Rapid deployment with minimal production disruption
              </p>
            </div>
          </div>
        </div>
